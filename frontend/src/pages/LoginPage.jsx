            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-surface-50 border border-surface-200/80 rounded-xl px-4 py-3 pr-10 text-[13px] text-navy-900 placeholder:text-surface-300 focus:border-navy-300 focus:ring-2 focus:ring-navy-100 focus:bg-white transition-all outline-none"

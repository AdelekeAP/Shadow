      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-stone-900">CS400 Courses</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-lg p-6 border border-stone-200">
            <div className="text-2xl font-bold text-stone-900">{enrolledCount}</div>
            <div className="text-sm text-stone-600">Enrolled Courses</div>
          </div>
          <div className="bg-white rounded-lg p-6 border border-stone-200">
            <div className="text-2xl font-bold text-stone-900">{compulsoryCount}</div>
            <div className="text-sm text-stone-600">Compulsory Courses</div>
          </div>
          <div className="bg-white rounded-lg p-6 border border-stone-200">
            <div className="text-2xl font-bold text-stone-900">{electiveCount}</div>
            <div className="text-sm text-stone-600">Elective Courses</div>
          </div>
          <div className="bg-white rounded-lg p-6 border border-stone-200">
            <div className="text-2xl font-bold text-stone-900">{courses.length}</div>
        ...
        {loading ? (
          <div className="flex justify-center items-center h-64">
            <div className="text-stone-600">Loading courses...</div>
          </div>
